...
$string['csv_loginscount'] = 'Logins count';
$string['csv_activedays'] = 'Active learning days';
$string['csv_overduecount'] = 'Overdue activities';
$string['csv_coursecompletion'] = 'Course completion %';
$string['csv_modulesunlocked'] = 'Modules unlocked';
$string['csv_quiz_firstacc'] = 'Quiz first-attempt accuracy % (avg)';
$string['csv_quiz_attemptsratio'] = 'Quiz attempts used / allowed %';
$string['csv_assign_feedbackrich'] = 'Assignment feedback (Y/N)';
$string['csv_competency_proficiency'] = 'Competency proficiency (Y/N)';
$string['csv_competency_achieveddate'] = 'Competency achieved date';
$string['csv_competency_lastupdated'] = 'Competency last updated';
$string['csv_quiz_bestpct'] = 'Quiz best % (avg)';
$string['csv_quiz_attempts'] = 'Quiz attempts used';
$string['csv_quiz_avgtime'] = 'Quiz avg time (s)';
$string['csv_assign_avgpct'] = 'Assignment avg grade %';
$string['csv_assign_ontimepct'] = 'On-time submission %';
$string['csv_assign_resub'] = 'Resubmissions';
$string['csv_forum_posts'] = 'Forum posts';
$string['csv_forum_replies'] = 'Forum replies';
$string['csv_badges'] = 'Badges earned';
$string['csv_competencies'] = 'Competencies achieved';
$string['lastlogin'] = 'Last login';
$string['lastcourseaccess'] = 'Last course access';
$string['activitiescompleted'] = 'Activities completed';
$string['assignmentsubmissions'] = 'Assignment submissions';
